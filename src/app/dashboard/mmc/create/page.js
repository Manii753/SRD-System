    ...
    <Layout>
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg font-semibold">MMC Fields</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              {dynamicDefs.length === 0 ? (
                <div className="text-gray-600">No dynamic fields defined for MMC. Add fields from Admin → Manage SRD Fields.</div>
              ) : (
